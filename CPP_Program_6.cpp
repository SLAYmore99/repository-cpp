...
int main()
{
    ...
    int size = 6;
    int target = 7;
    cout << "with recursion element is at index " << binary_search_with_recursion(arr, 0, size - 1, target) << endl;
    cout << "without recursion element is at index " << binary_search_without_recursion(arr, 0, size - 1, target);
